...
### 2. 🤖 AI機能① - 契約書AI-OCR（ワンステップ案件作成）

- **✨ ワンステップ案件作成**: ダッシュボードの「＋AIで案件作成」ボタンからPDFをアップロードするだけで案件を自動作成
...
- **自動情報抽出**: Gemini AIが重要情報を自動抽出
  ...
  - 手付金
  - 融資特約期限
- **自動案件作成**: 抽出データから新規案件を自動生成し、詳細画面に遷移
- **高精度OCR**: 日本語契約書に完全対応
